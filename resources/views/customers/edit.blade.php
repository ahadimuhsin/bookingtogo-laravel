...
<div class="container" style="margin-top: 50px">
    <div class="row">
        <div class="col-md-12">
            <h4 class="text-center">Edit Data {{ $customer->cst_name }}</a></h4>
            <div class="card border-0 shadow-sm rounded-md mt-4">
                <div class="card-body">
                    <form action="{{ route('customers.update', $customer->cst_id) }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="form-group">
                            <label for="cst_name" class="control-label">Nama</label>
                            <input type="text" class="form-control" id="cst_name" name="cst_name"
                                placeholder="Masukkan Nama Customer" value="{{ $customer->cst_name }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="cst_dob" name="cst_dob"
                                placeholder="Pilih Tanggal Lahir" value="{{ $customer->cst_dob }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="cst_phone" name="cst_phone"
                                placeholder="Nomor Telepon Customer" value="{{ $customer->cst_phone }}">
                        </div>

                        <div class="form-group">
                            <label for="cst_email" class="control-label">Email</label>
                            <input type="email" class="form-control" id="cst_email" name="cst_email"
                                placeholder="Masukkan Email Customer" value="{{ $customer->cst_email }}">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="nationality_id" id="nationality_id" class="form-control">
                                ...
                                <option value="{{ $item->nationality_id }}" {{ $item->nationality_id == $customer->nationality_id ? "selected" : "" }}>{{ $item->nationality_name }}</option>
                                @endforeach
                            </select>
                        </div>

                        <h3>Keluarga</h3>
                        @foreach ($customer->families as $item)
                                ...
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="family_name" name="family_name[]"
                                            placeholder="Nama Keluarga" value="{{ $item->fl_name }}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="family_relation"
                                            name="family_relation[]" value="{{ $item->fl_relation }}" placeholder="Hubungan Keluarga">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="date" class="form-control" id="family_dob" name="family_dob[]"
                                            placeholder="Tanggal Lahir Keluarga" value="{{ $item->fl_dob }}">
